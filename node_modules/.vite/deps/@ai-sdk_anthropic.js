import { B as postJsonToApi, D as isNonNullable, H as resolve, J as withUserAgentSuffix, M as loadApiKey, Mt as UnsupportedFunctionalityError, N as loadOptionalSetting, Q as _enum, R as parseProviderOptions, S as generateId, St as InvalidArgumentError, X as zodSchema, Y as withoutTrailingSlash, _ as createToolNameMapping, _t as unknown, a as combineHeaders, at as discriminatedUnion, bt as APICallError, ct as looseObject, d as createEventSourceResponseHandler, dt as object, ft as record, g as createProviderToolFactoryWithOutputSchema, gt as union, h as createProviderToolFactory, ht as tuple, j as lazySchema, kt as NoSuchModelError, m as createJsonResponseHandler, mt as string, nt as array, o as convertBase64ToUint8Array, p as createJsonErrorResponseHandler, q as validateTypes, rt as boolean, s as convertToBase64, st as literal, ut as number } from "./dist-COOqKIRy.js";
//#region node_modules/@ai-sdk/anthropic/dist/index.mjs
var VERSION = "3.0.71";
...
var anthropicLanguageModelOptions = object({
	...
	*/
userId: string().optional() }).optional(),
	/**
...
var webSearch_20260209ArgsSchema = lazySchema(() => zodSchema(object({
...
var webSearch_20260209OutputSchema = lazySchema(() => zodSchema(array(object({
	url: string(),
	title: string().nullable(),
...
var webFetch_20260209ArgsSchema = lazySchema(() => zodSchema(object({
	maxUses: number().optional(),
	allowedDomains: array(string()).optional(),
	blockedDomains: array(string()).optional(),
	citations: object({ enabled: boolean() }).optional(),
...
var webFetch_20260209OutputSchema = lazySchema(() => zodSchema(object({
	type: literal("web_fetch_result"),
	url: string(),
	content: object({
		type: literal("document"),
								...
								if (providerToolName === "web_fetch") {
									...
									if (output.type === "error-json") {
										...
										try {
											...
											errorValue = { errorCode: typeof extractedErrorCode === "string" ? extractedErrorCode : "unavailable" };
										}
										anthropicContent.push({
...
function getModelCapabilities(modelId) {
	if (modelId.includes("claude-opus-4-7")) return {
...
//#endregion
export { VERSION, anthropic, createAnthropic, forwardAnthropicContainerIdFromLastStep };
